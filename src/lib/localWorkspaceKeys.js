...
export const COVER_LETTER_STORAGE_KEY_PREFIX = 'resumeloomr:cover-letter:';
export const WORKSPACE_OPEN_FOLDERS_STORAGE_KEY = 'resumeloomr:open-folders:v1';
export const ACTIVE_DOCUMENT_VIEW_STORAGE_KEY = 'resumeloomr:active-document:v1';
...
export function createCoverLetterStorageKey(coverLetterId) {
  return `${COVER_LETTER_STORAGE_KEY_PREFIX}${coverLetterId}`;
}
